...
const navItems = [
  {
    ...
    label: "Dashboard",
    icon: (
      <svg aria-hidden="true" className="size-4.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      ...
      >
        ...
        <nav className="flex-1 px-3 py-4 flex flex-col gap-0.5 overflow-y-auto">
          ...
          <div className="mt-4 pt-4 border-t border-[#E2E8F0]">
            ...
            >
              <svg aria-hidden="true" className="size-4.5 text-[#94A3B8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
