    ...
    <div className="min-h-screen bg-[#F8FAFC] flex">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm">
          ...
          {/* Google OAuth */}
          <button className="w-full flex items-center justify-center gap-3 border border-[#E2E8F0] rounded-[8px] py-2.5 text-sm font-medium text-[#0F172A] hover:bg-[#F8FAFC] transition-colors mb-5">
